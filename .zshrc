...
alias javac="/opt/homebrew/opt/openjdk/bin/javac"
alias java="/opt/homebrew/opt/openjdk/bin/java"
alias us="~/projects/air-castles/update-script.sh"
# YouTube download (youtube-dl) with cookies sitting in my downloads folder.
# Nice for downloading a whole bunch of private videos.
alias ytc="youtube-dl --cookies ../../../Downloads/youtube.com_cookies.txt"
alias sesh="~/.local/bin/sesh"
alias oxy="ssh -i ~/.ssh/id_rsa bansie@143.110.239.211"
alias oxy-root="ssh -i ~/.ssh/id_rsa root@143.110.239.211"
