    ...
    updateAll(args) {
        ...
        this.extension.manager.getIncludedTeX().forEach(cachedFile => {
            ...
            cachedRefs.forEach(ref => {
                ...
                this.suggestions[ref.label] = Object.assign(Object.assign({}, ref), { file: cachedFile, position: ref.range instanceof vscode.Range ? ref.range.start : ref.range.inserting.start, range: args ? args.document.getWordRangeAtPosition(args.position, /[-a-zA-Z0-9_:.]+/) : undefined, prevIndex: this.prevIndexObj[ref.label] });
