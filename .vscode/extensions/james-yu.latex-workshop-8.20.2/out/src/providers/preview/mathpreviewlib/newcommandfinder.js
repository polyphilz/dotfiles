    ...
    async findNewCommand(content) {
        ...
        try {
            ...
            for (const node of ast.content) {
                if ((utils_1.isNewCommand(node) || latex_utensils_1.latexParser.isDefCommand(node)) && node.args.length > 0) {
            ...
            const noCommentContent = utils_1.stripCommentsAndVerbatim(content);
            let result;
            do {
