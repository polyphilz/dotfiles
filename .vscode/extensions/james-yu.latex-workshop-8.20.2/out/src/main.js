...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('latex-workshop-snippet-view', new snippetview_1.SnippetViewProvider(extension), { webviewOptions: { retainContextWhenHidden: true } }));
